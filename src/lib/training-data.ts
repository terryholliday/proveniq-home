...
export const trainingModules: TrainingModule[] = [
  {
    ...
    description: 'Learn how to describe Proveniq Home in 30 seconds and spark immediate interest.',
    level: 'Beginner',
    content: [
      {
        heading: 'The Core Concept',
        body: 'Proveniq Home is the operating system for your physical assets. We turn your static possessions into a dynamic, manageable, and protected inventory.',
      },
      {
    ...
    quiz: {
      questions: [
        {
          id: 'q1',
          question: 'What is the primary concept of Proveniq Home?',
          options: [
          ...
          correctIndex: 1,
          explanation: "Describing Proveniq Home as an 'operating system' effectively communicates its comprehensive and dynamic nature.",
        },
      ],
    },
  },
    ...
    content: [
      {
        ...
        body: "Acknowledge their effort first. Then, pivot to Proveniq Home's advantages. An Excel sheet is static; Proveniq Home is dynamic. It provides real-time market valuations, generates insurance reports with a click, and lets you attach photos, receipts, and even video stories to your items. Ask them, 'Can your spreadsheet tell you if your collectibles are trending up in value?'",
      },
      {
      ...
      questions: [
        {
          ...
          options: [
            ...
            'Immediately list all of Proveniq Homes features.',
  ...
  },
  {
    ...
    description: 'Understand how Proveniq Home connects with insurance, auctions, and legal services.',
    level: 'Advanced',
    content: [
      {
        heading: 'Beyond Inventory',
        body: "Proveniq Home is a platform, not just a product. Our value multiplies when we connect the user's inventory data to external services. This is our key strategic advantage.",
      },
    ],
  },
];
